...
class TouchInputController(
    ...
    private val steeringWheel =
        SteeringWheel(steeringWheelTexture).apply {
            setSize(WHEEL_SIZE, WHEEL_SIZE)
        }
    private val brake =
        Pedal(brakePedalTexture).apply {
            setSize(BRAKE_WIDTH, BRAKE_HEIGHT)
        }
    private val throttle =
        Pedal(throttlePedalTexture).apply {
...
internal fun steeringFromWheelTouch(
    localX: Float,
    wheelWidth: Float,
): Float {
