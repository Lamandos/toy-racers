...
class TrackLoader {
    ...
    private fun createTrack01(tiledObjects: TiledTrackObjects): Track =
        Track(
            ...
            startGrid =
                listOf(
                    ...
                    startPosition(9.0f, 7.5f),
                ),
            racingLine = OVAL_RACING_LINE.map { point(it.first, it.second) },
            racingLineWaypointRadius = 10f,
        )

    private fun createTrack02(tiledObjects: TiledTrackObjects): Track =
        Track(
    ...
    private fun startPosition(
        x: Float,
        y: Float,
    ): StartGridPosition = StartGridPosition(position = point(x, y), rotationDeg = 0f)
    ...
    companion object {
        ...
        private val BATHROOM_RACING_LINE =
            listOf(
                17.2f to 5.3f,
                21.5f to 5.3f,
                24.5f to 6.4f,
